...
> - ✅ 单文件与目录递归加解密可用
> - 🚧 仍处于“引擎优先”阶段，提供了最小 C++ Shell 右键桥接原型（Windows）
...
├── shell/                          # C++ Windows 右键桥接（调用 engine CLI）
│   ├── src/main.cpp                # 右键注册/注销 + 加密入口
│   └── README.md
└── AGENTS.md                    # 给 AI 的历史上下文（非用户文档）
```
